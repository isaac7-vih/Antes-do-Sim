...
function aceitou(){
    ...
    setTimeout(() => {
        ...
        caixa.innerText = `Você chegou devagar e de repente tomou conta de todo o meu coração. Fez eu ver que o amor não é apenas palavras, é presença, é cuidado, é querer estar junto não importa o que aconteça.
